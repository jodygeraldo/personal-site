...
export default function RadixHeroHeader({ translation, language }: Props) {
  return (
    <Popover.Root modal={true}>
      <div className="flex h-16 justify-between py-16">
        ...
        <div className="flex items-center lg:hidden">
          <Popover.Trigger className="inline-flex items-center justify-center rounded-md p-2 text-gray-11 hover:bg-gray-2 hover:text-gray-12 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-7 state-open:hidden">
